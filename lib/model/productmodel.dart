...
class ProductModel {
  ...
  ProductModel.fromMap(Map<String, dynamic> data, documentid, DocumentSnapshot docval) {
    name = data[NAME];
    ...
    docid = documentid;
    dummy = _convertPriceItems(data[DUMMYPRICE]??[{"mrp": '85', "variation": '750G',"offerprice": '75'}]);
  }
